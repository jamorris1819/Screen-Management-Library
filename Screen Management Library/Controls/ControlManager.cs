...
namespace Screen_Management_Library.Controls
{
    public class ControlManager : List<Control>
    {
        ...
        public void Update(GameTime gameTime, PlayerIndex playerIndex)
        {
            ...
            /* if (InputHandler.ButtonPressed(Buttons.LeftThumbstickDown, playerIndex) || InputHandler.ButtonPressed(Buttons.DPadDown, playerIndex)
                 || InputHandler.KeyPressed(Keys.Down) || InputHandler.KeyPressed(Keys.S))
                 NextControl();
             if (InputHandler.ButtonPressed(Buttons.LeftThumbstickUp, playerIndex) || InputHandler.ButtonPressed(Buttons.DPadUp, playerIndex)
                 || InputHandler.KeyPressed(Keys.Up) || InputHandler.KeyPressed(Keys.W))
                 PreviousControl();*/
        }
